							...
							<div className="row">
								<div className="col-lg-12">
									<div className="section-head text-center">
										...
										<h3>About Italian Frosty</h3>
										<p className="text-justify">Italian Frosty is a delightful and charming cake shop located in the bustling area of Navalur, Chennai. From cakes and baked goods to savory biryanis, our shop offers a wide variety of delicious treats and meals that cater to all tastes and preferences.</p>

										<p className="text-justify">At Italian Frosty, we are passionate about using only the finest ingredients in all of our creations. Our cakes are made with real butter, fresh cream, and high-quality chocolates and fruits to ensure a rich and satisfying taste in every bite. From classic flavors like chocolate and vanilla to more exotic options like red velvet and mango, our cakes are always made with care and attention to detail.</p>
										...
										<p className="text-justify">At Italian Frosty, we believe that quality should never be compromised, and that is reflected in every aspect of our shop. We take pride in using only the finest ingredients, and we are always experimenting with new and exciting flavors and combinations to keep things fresh and interesting. We are also committed to providing exceptional customer service, and we strive to make every customer feel welcome and valued.</p>
